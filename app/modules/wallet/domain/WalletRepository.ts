...
export interface WalletRepositoryI {
  findAuthenticated(): Promise<Result<WalletI[], InfrastructureError | ErrorNoAuthenticatedWalletsFound | ErrorCurrencyNotRecognized | ErrorInvalidBalance | ErrorUserNotAuthorized>>;
}
