...
export interface SignupFlowApiRepositoryI {
  ...
  submit(flowId: string): Promise<EmptyResult<InfrastructureError | SignupFlowNotFound | ErrorInvalidProfile | ErrorAlreadyTakenCpf | ErrorAlreadyTakenTelephone | ErrorAlreadyTakenEmail>>;
