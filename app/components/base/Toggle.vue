...
<template>
  <SwitchGroup as="div" class="flex items-center justify-between">
    ...
    <Switch
      v-model="enabled"
      :class="[enabled ? 'bg-button-emphasis' : 'bg-gray-200', disabled ? 'cursor-not-allowed' : 'cursor-pointer']"
      class="relative inline-flex h-6 w-11 shrink-0 rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring focus:ring-primary focus:ring-offset"
      :disabled="disabled"
