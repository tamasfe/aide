...
export interface paths {
    "/auth/whoami": {
        ...
        get: {
            ...
            responses: {
                ...
                /** @description Host Not Supported, Jurisdiction Not Supported, Jurisdiction Not Supported but Alternative Site Available, Jurisdiction Supported but Not Enabled, User Account Jurisdiction Mismatch */
                451: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/signup/form": {
        ...
        /**
         * Submit Signup Form
         * @description Submit a standalone signup form to create a new user.
         *
        ...
        post: {
            ...
            requestBody: {
                content: {
                    "application/json": components["schemas"]["SignupFormRequest"];
                };
            };
            responses: {
                /** @description no content */
    ...
    "/payment/deposit": {
        ...
        post: {
            ...
            responses: {
                ...
                /** @description Cooldown Period Active, Deposit Amount Negative, No Payment Provider Available, Payment Limits Exceeded, Payment Method Not Allowed, Timeframe Amount Limit Exceeded, Timeframe Count Limit Exceeded */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/payment/withdraw": {
        ...
        post: {
            ...
            responses: {
                ...
                /** @description Cooldown Period Active, Insufficient Funds, No Payment Provider Available, Payment Limits Exceeded, Payment Method Not Allowed, Pending Withdrawal Exists, Timeframe Amount Limit Exceeded, Timeframe Count Limit Exceeded, Withdrawal Amount Negative */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
    ...
    "/payment/currencies": {
         ...
         * @description Get all available payment currencies for the user's region.
         */
        get: {
            parameters: {
                query?: never;
    ...
    "/admin/payment/flow/{flow_id}/approve": {
        ...
        patch: {
            ...
            responses: {
                ...
                /** @description Insufficient Funds, Invalid Flow State, Invalid Flow Type, No payment provider available */
                400: {
                    headers: {
                        [name: string]: unknown;
                    };
...
export interface components {
    schemas: {
        ...
        /**
         * @description A Brazilian CPF (Cadastro de Pessoas Físicas) number.
         * @example 549.448.010-09
         */
        Cpf: string;
        ...
        CreateGameSessionPostResponse: {
             ...
             *      used to redirect the user back to the application after the game
             *      session. */
            return_url: string;
        ...
        GetPaymentCurrenciesErrorResponse: {
            /** @constant */
            code: "INTERNAL";
            metadata: Record<string, never>;
        };
        ...
        /**
         * @description A country represented by its ISO 3166-1 alpha-2 code with an optional language code represented by its ISO 639-1 code, e.g., 'en' or 'en-US'.
         * @example en
         * @example pt-BR
         */
        Language: string;
        ...
        SignupFormRequest: {
            document: components["schemas"]["ApiSignupDocument"];
            /** Format: email */
            email: string;
             ...
             *       "utm_term": null
             *     } */
            tracking_params: components["schemas"]["TrackingParams"];
        };
        Site: {
        ...
        /** @description Site setup response, used for dymainc frontend branding and configuration. */
        SiteResponse: {
            /** @description The specific domain setup serving the site. A site may have multiple
             *      domains, but only one is active for any given request. You can not
             *      get a list of all domains serving the site, as that would be a
             *      security risk. */
            domain: components["schemas"]["SiteDomain"];
            /** @description The currently active site. A system may have multiple sites, but only
             *      one is active for any given request. */
        ...
        TickerEnterPayload: {
            ...
            /** @description The ticker channel to enter. This is a string that identifies the
             *      channel. */
