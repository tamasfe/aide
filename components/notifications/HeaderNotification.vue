<template>
  <div
    ...
    class="relative flex w-full py-1 px-2 md:py-3 md:px-3 bg-header-notification-bg text-header-notification-text text-center h-10"
  >
    <span class="flex-1 text-xs md:text-base">
